    ...
    const getOptionClasses = (option: QuestionOptionDto) => {
        ...
        if (showResult) {
            ...
            if (option.isCorrect) {
                ...
                if (isSelected) {
                     classes.push('bg-green-100 p-2 rounded'); // Highlight selected and correct
                }
            } else if (isSelected && !option.isCorrect) {
                 // If showing results, mark selected but incorrect answers
                classes.push('text-red-700 font-semibold');
                 classes.push('bg-red-100 p-2 rounded'); // Highlight selected and incorrect
            } else {
        ...
        <Card className="mb-6">
            ...
            <CardContent>
                ...
                question.type === 'true_false' ? (
                 ...
                 {showResult && question.options.some(opt => opt.isCorrect) && (
