...
export const metadata: Metadata = {
  ...
  description: "User dashboard showcasing learning progress and quiz results.",
};
...
export default async function DashboardPage() {
  ...
  try {
    ...
    userData.sort((a, b) => new Date(b.completedAt).getTime() - new Date(a.completedAt).getTime());
  ...
  return (
    <div className="flex min-h-screen w-full flex-col">
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        <h1 className="text-3xl font-bold tracking-tight">Кабинет успеваемости студента</h1>
